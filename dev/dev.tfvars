...
user-pool-client-redirect-urls =["http://localhost:3000, http://localhost:3375/local.seahorse.finsemble/components/seaHorseAuthentication/SeaHorseAuthentication.html, https://streams.seahorse-dev.globallink.com/components/seaHorseAuthentication/SeaHorseAuthentication.html"]
user-pool-client-logout-urls   =["http://localhost:3000, http://localhost:3375/local.seahorse.finsemble/components/seaHorseAuthentication/SeaHorseAuthentication.html, https://streams.seahorse-dev.globallink.com/components/seaHorseAuthentication/SeaHorseAuthentication.html"]
